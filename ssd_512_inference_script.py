# -*- coding: utf-8 -*-
"""
Created on Wed Dec 15 11:29:06 2021
...
img_path = 'person_examples/'

input_img_paths = list(map(lambda x: os.path.join(img_path, x), os.listdir(img_path)))

for im_path in input_img_paths:
    orig_images.append(imread(im_path))
